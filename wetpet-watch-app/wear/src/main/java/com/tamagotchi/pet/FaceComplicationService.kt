 ...
 * same PixelPetRenderer pixel data, then wraps it in a complication.
 */
class FaceComplicationService : ComplicationDataSourceService() {
  ...
  override fun getPreviewData(type: ComplicationType): ComplicationData? {
    ...
    val bitmap = renderBitmap(FaceExpression.NEUTRAL, PixelPetRenderer.FACE_IDLE)
   ...
   * Uses the same PixelPetRenderer pixel data as the Compose Canvas version.
   */
  private fun renderBitmap(
    ...
    val pixelSize = BITMAP_SIZE.toFloat() / PixelPetRenderer.GRID
