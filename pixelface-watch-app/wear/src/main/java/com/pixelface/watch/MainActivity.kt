...
/**
 * Single Activity for the PixelFace Wear app.
 *
 ...
 * - PixelFaceWearApp reads it ONCE via LaunchedEffect, navigates forward,
...
class MainActivity : ComponentActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      PixelFaceWearApp(healthDataManager, pendingNavTarget)
    }
  }
  ...
  override fun onNewIntent(intent: Intent) {
    ...
    // Update the observable state — triggers LaunchedEffect in PixelFaceWearApp
